...
def p_view(q_view, dims):
    box_left, box_top, box_width, box_height, crosshair_x, crosshair_y = dims  # Updated dims
    pygame.font.init()
    ...
    win32gui.SetWindowPos(hwnd, win32con.HWND_TOPMOST, box_left - 40, box_top - 40, box_width + 80, box_height + 80, 0)  # Updated window size
